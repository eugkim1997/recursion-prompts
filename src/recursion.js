...
var palindrome = function(string) {
    if ((string.length === 1 || string.length === 2 || string.length === 3) && string[0] === string[string.length - 1]) {
        return true;
    } else if ((string.length === 1 || string.length === 2 || string.length === 3) && string[0] !== string[string.length - 1]) {
        return false;
    } else {
...
var fizzBuzz = function(n) {
    if (n === 1) {
        ...
        return fizzBuzz(n - 1).unshift([n.toString()]);
    }
};
